...
| **プレミアム動画**    | - プレミアム動画タイプの場合、「ビデオ + ヘッダ + メッセージ + ボタン + クーポン」で構成されます。<br>- ビデオフィールドは必須で、ヘッダ、メッセージ、ボタン、クーポンフィールドは任意です。<br>- ビデオリンクはカカオTVにアップロードされた動画のみ使用可能です。(`https://tv.kakao.com/v/#{数字}` / `https://tv.kakao.com/channel/#{数字}/cliplink/#{数字}`)<br>- `chat_bubble_type: "PREMIUM_VIDEO"`がこれに該当します。                                                                      | 画像なし                                                                                                                                                                                                        |
