...
| 공통      | false     | -1014      | 활성화되지 않은 발신 프로필일 경우                                                                                                                                                 |
...
| 공통      | false     | -1026      | 발신 프로필 그룹의 멤버 수가 5000개를 초과한 경우                                                                                                                                         |
...
| 공통      | false     | -2019      | 템플릿 본문 1,300글자 초과로 실패                                                                                                                                                |
...
| 공통      | false     | -2037      | 아이템 리스트 포함 템플릿 등록 시 메시지 본문 글자 수가 1000자를 초과한 경우                                                                                                                       |
...
| 공통      | false     | -3044      | 비즈니스폼(BF) 타입 버튼은 단독으로 사용하거나, 가장 위에 위치해야하는 제약에 어긋난 경우                                                                                                                 |
| 공통      | false     | -3045      | 비즈니스폼(BF) 타입의 name이 "톡에서 예약하기", "톡에서 설문하기", "톡에서 응모하기" 이 아닐 경우, 또는 등록되지 않은 bizFormKey일 경우                                                                            |
...
| 공통      | false     | -3330      | 채널 추가 버튼이 없는 세로 버튼 배열 시, 봇 전환(BT) 버튼은 첫 번째여야 합니다.                                                                                                                    |
...
| 공통      | false     | -3336      | 채널 추가 버튼이 있는 세로 버튼 배열 시, 봇 전환(BT) 버튼은 두 번째여야 합니다.                                                                                                                    |
| 공통      | false     | -3337      | 채널 추가 버튼이 없는 가로 버튼 배열 시, 봇 전환(BT) 버튼은 오른쪽(두 번째)이어야 합니다.                                                                                                              |
| 공통      | false     | -3338      | 채널 추가 버튼이 있는 가로 버튼 배열 시, 봇 전환(BT) 버튼은 왼쪽(첫 번째)이어야 합니다.                                                                                                               |
...
| 공통      | false     | -9992      | fade-out된 친구톡 API를 호출했을 경우                                                                                                                                           |
