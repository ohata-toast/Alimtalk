...
<tbody>
  ...
  <tr>
	...
	<tr>
		<td>3018</td>
		<td>메시지를 전송할 수 없음<br>1. 안드로이드 사용자의경우, "핸드폰 유심과 카카오톡 사용번호"가 다른 사람<br>2. 활성 사용자가 아닌 경우<br>활성 사용자란?<br> * 서버와 연결되어 있는 카카오톡 사용자<br> * 발송 당일 가입한 사용자를 제외한 최근 7일(168시간) 내에 카카오톡을 사용한 사용자<br>3. 제재 사용자 등<br></td>
	</tr>
    <tr>
		<td>3019</td>
