...
### 블랙리스트
특정 기준을 충족하지 못한 발신 프로필은 어뷰징 방지를 위해 블랙리스트에 등록되어 일부 기능에 제약을 받게 됩니다.
...
#### 블랙리스트 해제 기준
1. 발신 프로필 신규 등록 시 같은 프로젝트 내에 블랙리스트가 해제된 발신 프로필이 존재하는 경우 자동으로 블랙리스트가 해제됩니다.
2. 블랙리스트에 등록된 발신 프로필이 생성 후 한 달 이내에 과금 정상 발송 템플릿 건 수가 10건 이상인 경우, 다음날 자동으로 블랙리스트가 해제됩니다.
3. 이외 블랙리스트 해제가 필요한 경우 별도로 문의 바랍니다.