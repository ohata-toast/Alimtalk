...
* [API] 친구톡 Upgrade video 파라미터 개인화 기능 추가
    * 친구톡 Upgrade 발송 시 videoParameter 필드를 통해 동적으로 템플릿의 video 값을 변경하여 발송하는 기능이 추가되었습니다.
...
* [Console] 친구톡 Upgrade 엑셀 다운로드 기능 추가
    * 친구톡 Upgrade 발송 결과 조회 화면에서 엑셀 다운로드 기능이 추가되었습니다.
...
* [API, Console] 브랜드 메시지 기능 추가 - 예약 발송
  * 친구톡 Upgrade 서비스에 예약 발송 기능이 추가됩니다.
  * 원하는 시간에 친구톡 Upgrade 메시지를 예약하여 발송할 수 있습니다.
...
* [API] 브랜드 메시지 기본형 발송 시 수신자별로 템플릿 비디오 필드를 변경하는 기능 추가
  * 브랜드 메시지 기본형 발송 시 수신자별로 템플릿 비디오 필드를 변경할 수 있는 videoParameter 필드가 추가되었습니다.
    * 기본형 발송 시 videoParameter 필드를 통해 각 비디오 필드의 videoUrl, thumbnailUrl 의 값을 대체할 수 있습니다.
  
* [API] 브랜드 메시지 기본형 캐러셀 타입 발송에서도 수신자별 템플릿 이미지 필드 변경 가능
  * 브랜드 메시지 기본형 발송 시 캐러셀 타입에서도 수신자별로 템플릿 이미지 필드를 변경할 수 있도록 기능이 확장되었습니다.
